...
PROJECT_NAME="Smooth Component Filtering (SCF)"               # Put your project name
...
import os
import sys
sys.path.insert(0, os.path.abspath('/home/baijayanta/git_package/ps_pipeline/src/myutils/scf/'))  # Adjust the path if needed
...
sphinx-apidoc -o source/ /home/baijayanta/git_package/ps_pipeline/src/myutils/scf/ --force
...
cd build/latex/
#sed -i '58c\
#\\setcounter{tocdepth}{2}' smoothcomponentfilteringscf.tex



lualatex smoothcomponentfilteringscf.tex
lualatex smoothcomponentfilteringscf.tex

echo "Documentation successfully generated!"

cp smoothcomponentfilteringscf.pdf ../../../../.
