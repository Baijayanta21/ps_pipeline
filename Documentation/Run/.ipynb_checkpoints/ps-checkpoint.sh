...
PROJECT_NAME="Power Spectrum Estimation"               # Put your project name
...
import os
import sys
sys.path.insert(0, os.path.abspath('/home/baijayanta/git_package/ps_pipeline/src/myutils/psfuncs/'))  # Adjust the path if needed
...
sphinx-apidoc -o source/ /home/baijayanta/git_package/ps_pipeline/src/myutils/psfuncs/ --force
...
lualatex powerspectrumestimation.tex
lualatex powerspectrumestimation.tex

echo "Documentation successfully generated!"

cp powerspectrumestimation.pdf ../../../.