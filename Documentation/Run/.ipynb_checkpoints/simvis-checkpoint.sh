...
PROJECT_NAME="SIMVIS"               # Put your project name
AUTHOR_NAME="SC,AE,SB,BB"           # Put your Author names
...
import os
import sys
sys.path.insert(0, os.path.abspath('/home/baijayanta/git_package/ps_pipeline/src/myutils/simvis/'))  # Adjust the path if needed
...
sphinx-apidoc -o source/ /home/baijayanta/git_package/ps_pipeline/src/myutils/simvis/ --force
