...
PROJECT_NAME="maps"               # Put your project name
...
import os
import sys
sys.path.insert(0, os.path.abspath('/home/baijayanta/git_package/ps_pipeline/src/myutils/clfuncs/'))  # Adjust the path if needed
...
sphinx-apidoc -o source/ /home/baijayanta/git_package/ps_pipeline/src/myutils/clfuncs/ --force
